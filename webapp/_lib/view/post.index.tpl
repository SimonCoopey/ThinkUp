...
{include file="_statusbar.tpl"}
  <div class="thinkup-canvas round-all container_24">
      ...
      <div class="grid_4 alpha">
        ...
        <li{if $smarty.get.v eq ''} class="currentview"{/if}><a href="index.php?t={$post->post_id}&n={$post->network}">Post Details&nbsp;&nbsp;&nbsp;</a></li>
        </ul></li>
        {/if}
        {if $sidebar_menus}
            {foreach from=$sidebar_menus key=smkey item=sidebar_menu name=smenuloop}
                ...
                <li>{$m->heading}<ul class="side-subnav">
                    ...
                    <li{if $smarty.get.v eq $mi->short_name} class="currentview"{/if}><a href="index.php?v={$mi->short_name}&t={$post->post_id}&n={$post->network}">{$mi->name}&nbsp;&nbsp;&nbsp;</a></li>
                    {/foreach}</ul></li>
                {/foreach}
            {/foreach}
        {/if}
      ...
      <div class="grid_20 omega prepend_20 append_20">
        ...
        {if $post}
          <div class="clearfix">
            ...
            <div class="{if $replies or $retweets}grid_10{else}grid_16{/if}">
              <span class="tweet">
                {if $post->post_text}
              ...
              {/if}
              <div class="grid_8 omega small gray {if $replies or $retweets}prefix_3 prepend{else}prefix_10{/if}">
